    ...
    handleSubmit=()=>{
      if(this.state.fname==="" || this.state.lname==="" || this.state.class==="" || this.state.email===""
        ...
        if(this.state.password===this.state.confirmPassword){
            axios.post('http://localhost:5000/student/',{fname:this.state.fname,lname:this.state.lname,
    ...
    return (
      ...
      <div className={style.box}>
        <div style={{margin:'10%',marginLeft:'15%'}}>
          ...
          <div className={style.text}>Class</div>
            <input className={style.input} name={'class'} value={this.state.class} onChange={this.handle}></input>
          ...
          <div className={style.text}>Password</div>
            ...
            <input onClick={this.handleShow} value={this.state.passShow} name='passShow' type='checkbox'></input>
          <div className={style.text}>Confirm password</div>
            ...
            <input onClick={this.handleShow2} value={this.state.passShow2} name='passShow2' type='checkbox'></input>
        ...
        <div className={style.Box}>
          <div style={{margin:'10%',marginLeft:'15%'}}>
            ...
            <div className={style.text}>First name</div>
              ...
              <input className={style.input} name={'email'} value={this.state.email} onChange={this.handle}></input>
              <div className={style.text}>Password</div>
              <input className={style.input} type={this.state.passShow ? 'text':'password'} name={'password'} value={this.state.password} onChange={this.handle}></input>
              <input onClick={this.handleShow} value={this.state.passShow} name='passShow' type='checkbox'></input>
              <div className={style.text}>Confirm password</div>
              <input className={style.input} type={this.state.passShow2 ? 'text':'password'} name={'confirmPassword'} value={this.state.confirmPassword} onChange={this.handle}></input>
              <input onClick={this.handleShow2} value={this.state.passShow2} name='passShow2' type='checkbox'></input>
            <button className={style.button} onClick={()=>this.handleSubmit()}>Submit</button>
          </div>
        </div>
